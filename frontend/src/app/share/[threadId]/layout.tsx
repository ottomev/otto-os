...
export async function generateMetadata({ params }): Promise<Metadata> {
  ...
  const fallbackMetaData = {
    title: 'Shared Conversation | Otto',
    ...
    openGraph: {
      title: 'Shared Conversation | Otto',
      description: 'Replay this Agent conversation on Otto',
  ...
  try {
    ...
    const title = projectData.name || 'Shared Conversation | Otto';
    const description =
      projectData.description ||
      'Replay this Agent conversation on Otto';
