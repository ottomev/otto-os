      ...
      <div className="space-y-8">
        <section>
          ...
          <p className="text-lg mb-8">
            Credits are Ottos standard unit of measurement for platform usage. Think of them as tokens that power your AI agents - the more complex or lengthy the task, the more credits it requires.
          </p>
        </section>
        ...
        <section>
          ...
          <Alert className="mb-8">
            ...
            <AlertDescription>
              <strong>Credit Priority:</strong> When you use Otto, expiring credits are consumed first. 
        ...
        <section>
          ...
          <div className="flex flex-col sm:flex-row gap-3 mb-8">
            <Button
              variant="outline"
              className="gap-2"
              onClick={() => window.location.href = 'mailto:admin@otto.lk'}
            >
            ...
            <Button
              variant="outline"
              className="gap-2"
              onClick={() => window.open('https://discord.gg/otto', '_blank')}
            >
