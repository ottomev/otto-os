                  ...
                  {activeTab === 'imprint' ? (
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground text-balance mb-6">
                        ...
                        BINDING TERMS AND CONDITIONS FOR YOUR USE OF THE OTTO
                      ...
                      <ul className="text-muted-foreground space-y-1 mb-6">
                        ...
                        <li>
                          "Site" refers to the Otto website, including any related
                          features, content, or applications offered from time to
                          time by the Company.
                        </li>
                        <li>
                          "Service" refers to the Otto website and all related
                      ...
                      <p className="text-muted-foreground text-balance mb-6">
                        Otto is licensed under the Apache License, Version 2.0.
                      ...
                      <p className="text-muted-foreground text-balance mb-6">
                        All Otto logos, marks, and designations are trademarks or
                      ...
                      <p className="text-muted-foreground text-balance mb-6">
                        ...
                        LIMITATION, THE OTTO WEB APP AND ANY CONTENT) IS PROVIDED
                        ...
                        OTTO DOES NOT GUARANTEE THE ACCURACY, COMPLETENESS, OR
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground text-balance mb-6">
                        References to our "Services" at Otto in this statement
                      ...
                      <p className="text-muted-foreground text-balance mb-6">
                        Otto does not collect biometric or identifying
