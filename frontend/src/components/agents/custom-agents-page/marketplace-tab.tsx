...
interface MarketplaceTabProps {
  ...
  marketplaceFilter: 'all' | 'otto' | 'community' | 'mine';
  setMarketplaceFilter: (value: 'all' | 'otto' | 'community' | 'mine') => void;
    ...
    <div className="space-y-6 mt-8 flex flex-col min-h-full">
      <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center justify-between mb-6">
        ...
        <div className="flex items-center gap-3">
          <Select value={marketplaceFilter} onValueChange={(value: 'all' | 'otto' | 'community' | 'mine') => setMarketplaceFilter(value)}>
            ...
            <SelectContent className='rounded-xl'>
              ...
              <SelectItem className='rounded-xl' value="kortix">Otto Verified</SelectItem>
